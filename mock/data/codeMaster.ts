...
const SEED: Omit<CodeMasterRow, 'id'>[] = [
  ...
  { typeCode: 'property_status_tag', itemCode: 'for_rent', label: '出租', sortOrder: 40, isActive: 1, remark: null },
  { typeCode: 'property_status_tag', itemCode: 'rented', label: '已租', sortOrder: 50, isActive: 1, remark: null },
  { typeCode: 'property_status_tag', itemCode: 'for_sale', label: '出售', sortOrder: 60, isActive: 1, remark: null },
  ...
  { typeCode: 'property_listing_status', itemCode: 'for_rent', label: '出租', sortOrder: 10, isActive: 1, remark: null },
  { typeCode: 'property_listing_status', itemCode: 'rented', label: '已租', sortOrder: 20, isActive: 1, remark: null },
  { typeCode: 'property_listing_status', itemCode: 'for_sale', label: '出售', sortOrder: 30, isActive: 1, remark: null },
